...
public class MedicalSupplyData extends ServiceRequestData{
    ...
    public MedicalSupplyData(int requestID, String name, String room, String deliveryDate, String deliveryTime, String assignedStaff, String notes, String bandaid, String covidtest, String epipen, String gloves, String sthetiscope, String syringe) {
    ...
    public MedicalSupplyData(int requestID, String name, String room, String deliveryDate, String deliveryTime, String assignedStaff, String notes, String bandaid, String covidtest, String epipen, String gloves, String sthetiscope, String syringe, Status status) {
